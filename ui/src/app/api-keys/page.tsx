            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">Manage your API keys to access CallPilot services programmatically</p>
                    </div>
                        ...
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <CardDescription>
                                        Manage service keys for accessing hosted AI services (LLM, TTS, STT)
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text">
                                            Additional hosted service keys are available on paid plans.
                                        </span>
                                    )}
                                </div>
                            </div>
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a service key to access hosted AI services (LLM, TTS, STT)
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
