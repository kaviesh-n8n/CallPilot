...
export type ClientOptions = {
    baseUrl: 'https://app.callpilot.ai' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., callpilot_staging)
     */
...
export type CurrentUsageResponse = {
    ...
    period_end: string;
    /**
     * Used CallPilot Tokens
     */
    used_dograh_tokens: number;
    /**
     * Quota CallPilot Tokens
     */
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by CallPilot from fixed values or workflow context templates
     */
 ...
 * PresetToolParameter
 *
 * A parameter injected by CallPilot at runtime.
 */
