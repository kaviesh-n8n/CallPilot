...
## Step 2: Configure the cloned voice in CallPilot

1. Go to your agent's **Model Configuration** in the CallPilot dashboard.
...
Navigate to the **Recordings** page in the CallPilot dashboard. Recordings are shared across all agents in your organization. You can either upload pre-recorded audio files or record directly in the browser.
