...
| Field | Description |
| --- | --- |
| **Endpoint URL** | The URL CallPilot will send the POST request to. |
...
CallPilot sends a `POST` request with the following JSON payload:
...
```javascript
app.post("/callpilot/pre-call", async (req, res) => {
