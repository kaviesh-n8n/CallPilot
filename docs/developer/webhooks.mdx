...
description: "Context variables available in webhook nodes and the data CallPilot sends after a call"
---

CallPilot executes **webhook nodes** asynchronously after a workflow run completes. You configure the target URL, HTTP method, headers, and payload template directly in the workflow definition.
...
2. CallPilot executes any `webhook` nodes in the workflow asynchronously
