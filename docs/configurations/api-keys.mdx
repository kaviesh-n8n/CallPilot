...
description: "You can create API Keys to trigger CallPilot Voice Agents and Service Keys to use with Inference Providers"
---

The option to create the Keys are in https://app.callpilot.ai/api-keys if you are using hosted version, or http://localhost:3010/api-keys if you are using the self hosted version.
