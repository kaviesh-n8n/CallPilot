---
title: "Overview"
description: "Interact with CallPilot programmatically via the REST API"
---
...
```
https://your-callpilot-instance/api/v1
```

If you are using the hosted version, the base URL is `https://app.callpilot.ai/api/v1`.
...
```bash
curl -X POST https://your-callpilot-instance/api/v1/workflow/create/definition \
...
```bash
curl https://your-callpilot-instance/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-callpilot-instance",
  "deployment_mode": "oss",
  "auth_provider": "local"
}
```
