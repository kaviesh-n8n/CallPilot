...
description: "Assemble a CallPilot voice agent programmatically with the SDK and save it as a draft"
---
...
- An existing agent ID to save drafts against (create one in the CallPilot UI or via [`POST /api/v1/workflow/create`](/api-reference/agents/create-from-template))
...
<CodeGroup>
```python Python
from callpilot_sdk import CallPilotClient, Workflow
...
import { CallPilotClient, Workflow } from "@callpilot/sdk";
