...
description: "How CallPilot AI handles telephony webhooks and audio streaming"
---

## Overview

CallPilot AI uses webhooks to communicate with telephony providers for call events and audio streaming. Webhooks are automatically configured when you initiate calls.
