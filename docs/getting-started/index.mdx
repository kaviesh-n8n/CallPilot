...
**CallPilot is an open-source alternative to platforms like Vapi and Retell** - CallPilot helps you build voice AI agents with an easy drag-and-drop workflow builder. Unlike proprietary solutions like Vapi, CallPilot gives you:
...
## Overview
Watch the following video to learn about CallPilot’s capabilities.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/sxiSp4JXqws"
  title="CallPilot Overview"
