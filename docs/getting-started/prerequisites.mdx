---
title: "Prerequisites"
description: "System requirements and setup needed to run CallPilot AI locally"
---
...
To run CallPilot AI locally, make sure you have the following installed:
...
CallPilot images are available from two registries:
